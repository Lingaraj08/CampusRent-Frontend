    ...
    <div className="min-h-screen bg-[#f6f7fb] pb-24">
      ...
      <header className="bg-white sticky top-0 z-10 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-[#2563eb]">Search</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-4">
        ...
        <div className="relative mb-4">
          <div className="flex items-center gap-3 px-4 py-3 rounded-2xl border-2 border-[#4c40f5] bg-white shadow-sm">
            <svg className="w-5 h-5 text-[#7b819a]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-sm text-[#1f2433] placeholder:text-[#9aa0b5]"
            />
          </div>
        </div>
        ...
        <section className="mb-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <button onClick={() => setSelectedCategory(null)} className="text-sm font-medium text-[#2563eb]">Reset</button>
          </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-5 h-16 text-[#72788f]">
            ...
            <Link href="/search" className="flex flex-col items-center justify-center text-[#2563eb]">
